...
**Süre 200 → 260 ms.** Tam genişlik için 200 ms aceleci. Bu, önceki turun "splash ile ekran geçişi aynı tempoda olsun" premisini geçersiz kıldı — testteki o iddia **gevşetilmedi, düzeltildi**: ikisi de kısa bantta (150-320 ms) olsun yeter; biri opaklık sönmesi, diğeri 390 px'lik bir yol.
